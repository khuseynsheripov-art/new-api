    ...
    if (success) {
      ...
      if (data.setting) {
        try {
          ...
          data.sanitize_messages = parsedSettings.sanitize_messages || false;
        } catch (error) {
            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch field='sanitize_messages' label={t('Message Sanitization')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelSettingsChange('sanitize_messages', value)} extraText={t('Trim assistant trailing whitespace and remove assistant prefill for thinking models')} />
